...
static Stmt *statement(Parser *p) {
  ...
  if (match(p, 1, TOKEN_LEFT_BRACE)) {
    ...
    if (match(p, 30, TOKEN_UI_CONTAINER, TOKEN_UI_BUTTON, TOKEN_UI_TEXT, TOKEN_UI_INPUT, TOKEN_UI_STYLE,
              ...
              TOKEN_UI_TABLE, TOKEN_UI_THEAD, TOKEN_UI_TBODY, TOKEN_UI_TR, TOKEN_UI_TH, TOKEN_UI_TD,
              TOKEN_UI_VIDEO, TOKEN_UI_AUDIO, TOKEN_UI_CANVAS, TOKEN_UI_PRE, TOKEN_UI_CODE,
              TOKEN_UI_MAIN, TOKEN_UI_ASIDE)) {
