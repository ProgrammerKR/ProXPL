# ProXPL v1.6.4: The "Concurrency Core" Release
...
ProXPL v1.6.4 introduces a first-class **Concurrency Model** with **Channels**, **Structured Concurrency**, and **Actor-based messaging**. It also delivers **Database Connectivity** (`std.db`), **Serialization** (`std.encoding`), and the **Language Server Protocol v2** with semantic analysis.
...
*ProXPL v1.6.4 — Concurrent, connected, compile-time powered.*
